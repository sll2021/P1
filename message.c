...
void RunHistoryCommand(char** args);
    ...
    while (should_run) {
        ...
        */
        ...
        else 
        {
            ...
            history_buffer = strdup(buffer); // TODO: Make sure !! isnt stored in here!
...
{       
    ...
    else
    {
        ...
        ParseInput(history_buffer, args); //place new command in history argument list
    }
}
